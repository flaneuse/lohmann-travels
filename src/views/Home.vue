...
<div>
  <h1>
    How many counties in the United States have the Lohmann family visited?
  </h1>
    ...
    onEachFeatureFunction() {
      return (feature, layer) => {
        ...
        layer.bindTooltip(
          ...
          <div>
          Shelley: ${feature.properties.Shelley ? '<i class="fas fa-square"></i>' : '<i class="far fa-square"></i>'}
          </div>
          <div>
          Jim: ${feature.properties.Jim ? '<i class="fas fa-square"></i>' : '<i class="far fa-square"></i>'}
          </div>
          <div>
